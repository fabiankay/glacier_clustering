...
# glacier_clustering documentation build
...
from glacier_clustering import __version__ as release

# -- Project information -----------------------------------------------------

project = "glacier_clustering"
author = "Kedro"
...
htmlhelp_basename = "glacier_clusteringdoc"
...
latex_documents = [
    (
        master_doc,
        "glacier_clustering.tex",
        "glacier_clustering Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "glacier_clustering",
        "Project glacier_clustering codebase.",
        "Data-Science",
    )
]
